...
func Test_LimiterByIpH(t *testing.T) {
    var nNumeroDeChamadas int = 1000
    ...
    assert.Less(t, Http200.Load(), int64(200))
    assert.Greater(t, Http429.Load(), int64(10))
    assert.Equal(t, int64(0), HttpOutros.Load())
}
...
func Test_LimiterByApiKyH(t *testing.T) {
    var nNumeroDeChamadas int = 1000
